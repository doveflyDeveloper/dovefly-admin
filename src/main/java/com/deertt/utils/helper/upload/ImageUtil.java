...
//        }
    ...
    private static void WriteImage(String targetPath, BufferedImage image) throws IOException {
        ...
        String formatName = targetPath.substring(targetPath.lastIndexOf(".") + 1);
...
//		String dest = "D:\\var\\4.png";
        try {
            ImageUtil.fill(src, dest, 200, 200);
            //ImageUtil.waterMark(src, dest, "/Users/karas/Pictures/tree56.png", YPOS.top, XPOS.left, 10);
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
