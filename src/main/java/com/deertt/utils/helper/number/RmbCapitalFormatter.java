...
public class RmbCapitalFormatter {
	...
	// 大写对应数组
	private static final String RMB_CAPITAL[] = { "零", "壹", "贰", "叁", "肆", "伍", "陆", "柒", "捌", "玖", "拾" };
	...
	public static void main(String[] args){
		RmbCapitalFormatter rmbCF = new RmbCapitalFormatter();
		System.out.println(rmbCF.format(202.10));//不对啊
		System.out.println(rmbCF.format(0200.09));
