package com.deertt.module.fund.interest.web;
 ...
 */
@Controller
@RequestMapping("/interestController")
public class InterestController extends DvBaseController implements IInterestConstants {
	
	@Autowired
	protected IInterestService service;
	...
	public String query(HttpServletRequest request) throws Exception {
		...
		List<InterestVo> beans = service.queryByCondition(queryCondition, orderStr, pageVo.getStartIndex(), pageVo.getPageSize());
		request.setAttribute(REQUEST_BEANS, beans);
		return JSP_PREFIX + "/listInterest";
	}
