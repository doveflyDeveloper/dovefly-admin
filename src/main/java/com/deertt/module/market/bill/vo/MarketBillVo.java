 ...
 * @since 1.0.0
 */
public class MarketBillVo extends DvBaseVo {
	private static final long serialVersionUID = 1L;
	
	public static final String BILL_CODE_PREFIX = "M";//单号前缀
	...
	private List<MarketDetailVo> details;
	...
	public List<MarketDetailVo> getDetails() {
		return details;
	}
	
	public void setDetails(List<MarketDetailVo> details) {
