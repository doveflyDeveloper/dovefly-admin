package com.deertt.module.market.bill.vo;
 ...
 * @since 1.0.0
 */
public class MarketDetailVo extends DvBaseVo {
	...
	private BigDecimal limit_coin_quantity;
	
	private BigDecimal send_coin_quantity;
	...
	public BigDecimal getLimit_coin_quantity() {
		return limit_coin_quantity;
	}

	public void setLimit_coin_quantity(BigDecimal limit_coin_quantity) {
		this.limit_coin_quantity = limit_coin_quantity;
	}

	public BigDecimal getSend_coin_quantity() {
		return send_coin_quantity;
	}

	public void setSend_coin_quantity(BigDecimal send_coin_quantity) {
