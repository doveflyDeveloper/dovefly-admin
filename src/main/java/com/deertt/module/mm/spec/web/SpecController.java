package com.deertt.module.mm.spec.web;
 ...
 */
@Controller
@RequestMapping("/specController")
public class SpecController extends DvBaseController implements ISpecConstants {
	
	@Autowired
	protected ISpecService service;
	...
	public String insert(HttpServletRequest request, SpecVo vo, RedirectAttributes attr) throws Exception {
	...
	public String update(HttpServletRequest request, SpecVo vo, RedirectAttributes attr) throws Exception {
	...
	public String query(HttpServletRequest request) throws Exception {
		...
		List<SpecVo> beans = service.queryByCondition(queryCondition, orderStr, pageVo.getStartIndex(), pageVo.getPageSize());
		request.setAttribute(REQUEST_BEANS, beans);
		return JSP_PREFIX + "/listSpec";
	}
	...
	public String reference( HttpServletRequest request) throws Exception {
		query(request);
		return JSP_PREFIX + "/referenceSpec";
	}
	...
	protected String getQueryCondition(HttpServletRequest request) {
		...
		if (request.getAttribute(REQUEST_QUERY_CONDITION) != null) {
			...
			lQuery.add(DvSqlHelper.buildQueryStr("quantity", request.getParameter("quantity"), DvSqlHelper.TYPE_NUMBER_EQUAL));
