package com.deertt.module.pay.alipaybill.web;
 ...
 */
@Controller
@RequestMapping("/alipayBillController")
public class AlipayBillController extends DvBaseController implements IAlipayBillConstants {
	
	@Autowired
	protected IAlipayBillService service;
	...
	public String create(HttpServletRequest request) throws Exception {
		return JSP_PREFIX + "/insertAlipayBill";
	}
	...
	public String copy(HttpServletRequest request, @PathVariable Integer id) throws Exception {
		AlipayBillVo bean = service.find(id);
		bean.setId(null);
	...
	public String insert(HttpServletRequest request, AlipayBillVo vo, RedirectAttributes attr) throws Exception {
	...
	public String update(HttpServletRequest request, AlipayBillVo vo, RedirectAttributes attr) throws Exception {
	...
	public String detail(HttpServletRequest request, @PathVariable(REQUEST_ID) Integer id) throws Exception {
		AlipayBillVo bean = service.find(id);
		request.setAttribute(REQUEST_BEAN, bean);
		return JSP_PREFIX + "/detailAlipayBill";
	}
	...
	public String query(HttpServletRequest request) throws Exception {
		...
		List<AlipayBillVo> beans = service.queryByCondition(queryCondition, orderStr, pageVo.getStartIndex(), pageVo.getPageSize());
		request.setAttribute(REQUEST_BEANS, beans);
		return JSP_PREFIX + "/listAlipayBill";
	}
	...
	protected String getQueryCondition(HttpServletRequest request) {
		...
		if (request.getAttribute(REQUEST_QUERY_CONDITION) != null) {
			...
			lQuery.add(DvSqlHelper.buildQueryStr("trans_date", request.getParameter("trans_date_from"), DvSqlHelper.TYPE_DATE_GREATER_EQUAL));
			lQuery.add(DvSqlHelper.buildQueryStr("trans_date", request.getParameter("trans_date_to"), DvSqlHelper.TYPE_DATE_LESS_EQUAL));
			lQuery.add(DvSqlHelper.buildQueryStr("merchant_out_order_no", request.getParameter("merchant_out_order_no"), DvSqlHelper.TYPE_CHAR_LIKE));
