package com.deertt.module.crm.supplier.web;
...
public class SupplierController extends DvBaseController implements ISupplierConstants {
	...
	public String create(HttpServletRequest request) throws Exception {
		return JSP_PREFIX + "/insertSupplier";
	}
	...
	public String copy(HttpServletRequest request, @PathVariable Integer id) throws Exception {
		SupplierVo bean = service.find(id);
		bean.setId(null);
	...
	public String insert(HttpServletRequest request, SupplierVo vo, RedirectAttributes attr) throws Exception {
	...
	public String update(HttpServletRequest request, SupplierVo vo, RedirectAttributes attr) throws Exception {
	...
	public String detail(HttpServletRequest request, @PathVariable(REQUEST_ID) Integer id) throws Exception {
		SupplierVo bean = service.find(id);
		request.setAttribute(REQUEST_BEAN, bean);
		return JSP_PREFIX + "/detailSupplier";
	}
	...
	public String query(HttpServletRequest request) throws Exception {
		...
		List<SupplierVo> beans = service.queryByCondition(queryCondition, orderStr, pageVo.getStartIndex(), pageVo.getPageSize());
		request.setAttribute(REQUEST_BEANS, beans);
		return JSP_PREFIX + "/listSupplier";
	}
	...
	public String reference( HttpServletRequest request) throws Exception {
		query(request);
		return JSP_PREFIX + "/referenceSupplier";
	}
	...
	protected String getQueryCondition(HttpServletRequest request) {
		...
		if (request.getAttribute(REQUEST_QUERY_CONDITION) != null) {
			...
			if (LoginHelper.isSuperAdminRole() || LoginHelper.isHeadquartersRole()) {
			...
			lQuery.add(DvSqlHelper.buildQueryStr("tel", request.getParameter("tel"), DvSqlHelper.TYPE_CHAR_LIKE));
			lQuery.add(DvSqlHelper.buildQueryStr("address", request.getParameter("address"), DvSqlHelper.TYPE_CHAR_LIKE));
			lQuery.add(DvSqlHelper.buildQueryStr("linkman", request.getParameter("linkman"), DvSqlHelper.TYPE_CHAR_LIKE));
			lQuery.add(DvSqlHelper.buildQueryStr("linkman_mobile", request.getParameter("linkman_mobile"), DvSqlHelper.TYPE_CHAR_LIKE));
