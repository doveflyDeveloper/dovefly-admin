package com.deertt.module.sys.city.web;
...
import com.deertt.module.sys.city.service.ICityService;
...
public class CityController extends DvBaseController implements ICityConstants {
	...
	public String insert(HttpServletRequest request, CityVo vo, RedirectAttributes attr) throws Exception {
		DvVoHelper.markCreateStamp(request, vo);
		service.insert(vo);
		DvDictionaryFactory.getSingleton().reload("DIC_SYS_CITY");
	...
	public String update(HttpServletRequest request, CityVo vo, RedirectAttributes attr) throws Exception {
	...
	public String query(HttpServletRequest request) throws Exception {
		...
		List<CityVo> beans = service.queryByCondition(queryCondition, orderStr, pageVo.getStartIndex(), pageVo.getPageSize());
		request.setAttribute(REQUEST_BEANS, beans);
		return JSP_PREFIX + "/listCity";
	}
	...
	public String reference( HttpServletRequest request) throws Exception {
		query(request);
		return JSP_PREFIX + "/referenceCity";
	}
