package com.deertt.module.mv.show.web;
 ...
 */
@Controller
@RequestMapping("/mvShowController")
public class MvShowController extends DvBaseController implements IMvShowConstants {
	
	@Autowired
	protected IMvShowService service;
	...
	public String create(HttpServletRequest request) throws Exception {
		return JSP_PREFIX + "/insertMvShow";
	}
	...
	public String insert(HttpServletRequest request, MvShowVo vo, RedirectAttributes attr) throws Exception {
	...
	public String update(HttpServletRequest request, MvShowVo vo, RedirectAttributes attr) throws Exception {
	...
	public String deny(HttpServletRequest request, @PathVariable(REQUEST_ID) Integer id, RedirectAttributes attr) throws Exception {
		...
		return redirectWithTip("/mvShowController/detail/" + id, attr);
	}
	...
	public String agree(HttpServletRequest request, @PathVariable(REQUEST_ID) Integer id, RedirectAttributes attr) throws Exception {
		String reason = request.getParameter("agreereason");
		service.agree(id, reason);
		return redirectWithTip("/mvShowController/detail/" + id, attr);
	}
	...
	public String detail(HttpServletRequest request, @PathVariable(REQUEST_ID) Integer id) throws Exception {
		MvShowVo bean = service.findFull(id);
		request.setAttribute(REQUEST_BEAN, bean);
		return JSP_PREFIX + "/detailMvShow";
	}
	...
	public String query(HttpServletRequest request) throws Exception {
		...
		List<MvShowVo> beans = service.queryByCondition(queryCondition, orderStr, pageVo.getStartIndex(), pageVo.getPageSize());
		request.setAttribute(REQUEST_BEANS, beans);
		return JSP_PREFIX + "/listMvShow";
	}
	...
	public String reference( HttpServletRequest request) throws Exception {
		query(request);
		return JSP_PREFIX + "/referenceMvShow";
	}
