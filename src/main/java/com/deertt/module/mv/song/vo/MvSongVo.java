 ...
 * @since 1.0.0
 */
public class MvSongVo extends DvBaseVo {
	...
	//剧本投票明细表
	private List<MvSongSupportVo> details;
	...
	/** 获取投票详情*/
	public List<MvSongSupportVo> getDetails() {
		return details;
	}
	
	/** 设置投票详情*/
	public void setDetails(List<MvSongSupportVo> details) {
