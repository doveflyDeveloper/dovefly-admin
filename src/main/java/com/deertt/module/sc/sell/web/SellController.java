package com.deertt.module.sc.sell.web;
...
import com.deertt.module.sc.sell.service.ISellService;
...
public class SellController extends DvBaseController implements ISellConstants {
	
	@Autowired
	protected ISellService service;
	...
	public String insert(HttpServletRequest request, SellVo vo, RedirectAttributes attr) throws Exception {
	...
	public String update(HttpServletRequest request, SellVo vo, RedirectAttributes attr) throws Exception {
	...
	public String query(HttpServletRequest request) throws Exception {
		...
		List<SellVo> beans = service.queryByCondition(queryCondition, orderStr, pageVo.getStartIndex(), pageVo.getPageSize());
		request.setAttribute(REQUEST_BEANS, beans);
		return JSP_PREFIX + "/listSell";
	}
	...
	public String reference( HttpServletRequest request) throws Exception {
		query(request);
		return JSP_PREFIX + "/referenceSell";
	}
	...
	protected String getQueryCondition(HttpServletRequest request) {
		...
		if (request.getAttribute(REQUEST_QUERY_CONDITION) != null) {
			...
			lQuery.add(DvSqlHelper.buildQueryStr("is_new", request.getParameter("is_new"), DvSqlHelper.TYPE_CUSTOM, "='", "'"));
			lQuery.add(DvSqlHelper.buildQueryStr("price", request.getParameter("price_from"), DvSqlHelper.TYPE_NUMBER_GREATER_EQUAL));
			lQuery.add(DvSqlHelper.buildQueryStr("price", request.getParameter("price_to"), DvSqlHelper.TYPE_NUMBER_LESS_EQUAL));
			lQuery.add(DvSqlHelper.buildQueryStr("old_price", request.getParameter("old_price_from"), DvSqlHelper.TYPE_NUMBER_GREATER_EQUAL));
			lQuery.add(DvSqlHelper.buildQueryStr("old_price", request.getParameter("old_price_to"), DvSqlHelper.TYPE_NUMBER_LESS_EQUAL));
			lQuery.add(DvSqlHelper.buildQueryStr("seller_name", request.getParameter("seller_name"), DvSqlHelper.TYPE_CHAR_LIKE));
			lQuery.add(DvSqlHelper.buildQueryStr("seller_mobile", request.getParameter("seller_mobile"), DvSqlHelper.TYPE_CHAR_LIKE));
			lQuery.add(DvSqlHelper.buildQueryStr("seller_qq", request.getParameter("seller_qq"), DvSqlHelper.TYPE_CHAR_LIKE));
			lQuery.add(DvSqlHelper.buildQueryStr("seller_weixin", request.getParameter("seller_weixin"), DvSqlHelper.TYPE_CHAR_LIKE));
			lQuery.add(DvSqlHelper.buildQueryStr("image", request.getParameter("image"), DvSqlHelper.TYPE_CHAR_LIKE));
			lQuery.add(DvSqlHelper.buildQueryStr("images", request.getParameter("images"), DvSqlHelper.TYPE_CHAR_LIKE));
			...
			lQuery.add(DvSqlHelper.buildQueryStr("sort", request.getParameter("sort_from"), DvSqlHelper.TYPE_NUMBER_GREATER_EQUAL));
			lQuery.add(DvSqlHelper.buildQueryStr("sort", request.getParameter("sort_to"), DvSqlHelper.TYPE_NUMBER_LESS_EQUAL));
			lQuery.add(DvSqlHelper.buildQueryStr("status", request.getParameter("status"), DvSqlHelper.TYPE_CUSTOM, "='", "'"));
			lQuery.add(DvSqlHelper.buildQueryStr("create_by", request.getParameter("create_by_from"), DvSqlHelper.TYPE_NUMBER_GREATER_EQUAL));
			lQuery.add(DvSqlHelper.buildQueryStr("create_by", request.getParameter("create_by_to"), DvSqlHelper.TYPE_NUMBER_LESS_EQUAL));
			lQuery.add(DvSqlHelper.buildQueryStr("create_at", request.getParameter("create_at_from"), DvSqlHelper.TYPE_DATE_GREATER_EQUAL));
			lQuery.add(DvSqlHelper.buildQueryStr("create_at", request.getParameter("create_at_to"), DvSqlHelper.TYPE_DATE_LESS_EQUAL));
			lQuery.add(DvSqlHelper.buildQueryStr("modify_by", request.getParameter("modify_by_from"), DvSqlHelper.TYPE_NUMBER_GREATER_EQUAL));
			lQuery.add(DvSqlHelper.buildQueryStr("modify_by", request.getParameter("modify_by_to"), DvSqlHelper.TYPE_NUMBER_LESS_EQUAL));
			lQuery.add(DvSqlHelper.buildQueryStr("modify_at", request.getParameter("modify_at_from"), DvSqlHelper.TYPE_DATE_GREATER_EQUAL));
			lQuery.add(DvSqlHelper.buildQueryStr("modify_at", request.getParameter("modify_at_to"), DvSqlHelper.TYPE_DATE_LESS_EQUAL));
