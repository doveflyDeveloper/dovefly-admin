...
<script type="text/javascript">
	...
	function query_onclick() {
		if (validateForm()){
			formHelper.jSubmit(formHelper.buildAction("marketBillReportController", "reportGroupByMarket"));
		}
	}
	...
	function export_onclick() {
		...
		formHelper.submit(formHelper.buildAction("marketBillReportController", "exportGroupByMarket", ids));
	}
			...
			<div class="padding_2_div">
				<table class="list_table">
					<tr>
						<th width="5%">序号</th>
						<th width="15%">超市</th>
						<th width="15%">订单量（笔）</th>
						<th width="15%">订单总额（元）</th>
					</tr>
