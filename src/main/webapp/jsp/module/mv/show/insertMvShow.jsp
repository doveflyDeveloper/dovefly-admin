...
<title>电影剧本<%=isModify ? "修改" : "新增"%></title>
<style type="text/css">
<!--
-->
</style>
	...
	<form id="form" name="form" method="post">
		...
		<div class="border_div" >
			<div class="header_div">
				<div class="left_div">
					<div class="table_title">电影剧本<%= isModify ? "修改" : "新增"%>&nbsp;</div>
			...
			<div>
				<table class="insert_table">
					...
					<tr>
						...
						<td class="field">
							<input type="text" name="mv_name" class="input" inputName="剧本名称" value="<c:out value="${bean.mv_name }"/>" maxlength="50" validate=""/>
						</td>
						<td class="label">剧本类型：</td>
						<td class="field">
							<input type="text" name="mv_type" class="input" inputName="剧本类型" value="<c:out value="${bean.mv_type }"/>" maxlength="10" validate=""/>
						</td>
					</tr>
					<tr>
						<td class="label">剧本梗概：</td>
						<td class="field">
							<textarea name="mv_brief" class="input" inputName="剧本梗概">${bean.mv_brief }</textarea>
						</td>
						<td class="label">剧照图：</td>
						<td class="field">
							<input type="text" name="mv_images" class="input" inputName="剧照图" value="<c:out value="${bean.mv_images }"/>" maxlength="200" validate=""/>
						</td>
					</tr>
					<tr>
						...
						<td class="field">
							<textarea name="mv_desc" class="input" inputName="剧本大纲">${bean.mv_desc }</textarea>
						</td>
					</tr>
					<tr>
						<td class="label">剧本附件：</td>
						<td class="field">
							<input type="text" name="mv_file" class="input" inputName="剧本附件" value="<c:out value="${bean.mv_file }"/>" maxlength="100" validate=""/>
						</td>
