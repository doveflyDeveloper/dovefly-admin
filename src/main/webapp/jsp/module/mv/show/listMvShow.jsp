...
<body>
	<form id="form" name="form" method="get">
			...
			<div class="padding_2_div">
				<table class="query_table">
					<tr>
						...
						<td class="field">
							<dv:select name="city_id" dicKeyword="DIC_SYS_CITY" hasEmpty="true" defaultValue="${param.city_id }" ignoreValues="1"/>
						</td>
						...
						<td class="field">
							<input type="text" name="name" class="input" maxlength="20" value="<c:out value="${param.name }"/>"/>
						</td>
					</tr>
					<tr>
						<td class="label">手机号：</td>
						<td class="field">
							<input type="text" name="mobile" class="input" maxlength="20" value="<c:out value="${param.mobile }"/>"/>
						</td>
						<td class="label">剧本名称：</td>
						<td class="field">
							<input type="text" name="mv_name" class="input" maxlength="50" value="<c:out value="${param.mv_name }"/>"/>
						</td>
						<td class="label">剧本类型：</td>
						<td class="field">
							<input type="text" name="mv_type" class="input" maxlength="10" value="<c:out value="${param.mv_type }"/>"/>
						</td>
					</tr>
				</table>
			</div>
		...
		<div class="border_div" >
			<div class="header_div">
				<div class="left_div">
					<div class="table_title">电影剧本列表&nbsp;</div>
				</div>
				<div class="right_div">
					<div class="right_menu">
			...
			<div class="padding_2_div">
				<table class="list_table">
					...
					<tr>
						...
						<td><c:out value="${bean.recommend_name }"/></td>
						<td><a href="javascript:detail_onclick('<c:out value="${bean.id }"/>')"><c:out value="${bean.name }"/></a></td>
						<td><c:out value="${bean.mobile }"/></td>
						<td><c:out value="${bean.major }"/></td>
						<td><c:out value="${bean.mv_name }"/></td>
						<td><c:out value="${bean.mv_type }"/></td>
						<td><c:out value="${bean.mv_coin }"/></td>
					</tr>
					</c:forEach>
				</table>
			</div>
