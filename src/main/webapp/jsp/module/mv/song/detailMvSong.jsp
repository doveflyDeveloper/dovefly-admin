...
<script type="text/javascript">
	...
	function  agree_onclick(){
        formHelper.jSubmit(formHelper.buildAction("mvSongController", "agree", "${bean.id }"));
	}
	...
	function  deny_onclick(){
		dvPrompt(window.denyDivHtml, '填写拒绝信息', {
			...
			submit: function(v, h, f) {
				...
				formHelper.jSubmit(formHelper.buildAction("mvSongController", "deny", "${bean.id }"));
				return true;
			}
		});
	...
	$(document).ready(function() {
		...
		for (var i in mv_images) {
			imgHtml += '<video controls="controls" height="650" src="https://ods5st3df.qnssl.com/' + mv_images[i] + '" />';
		}
						...
						<div>
				          <table class="detail_table">
							...
							<tr>
								...
								<td class="field" colspan="3"><c:out value="${bean.mv_brief }" escapeXml="false"/></td>
							</tr>
							<tr>
