...
<script type="text/javascript">
	...
	function export_onclick() {
		...
		formHelper.submit(formHelper.buildAction("orderBillReportController", "exportManagerGroupBySchool", ids));
	}
	...
	function reportManagerSchool_onclick(school_id) {
		...
		var url = context_path + "/orderBillReportController/reportShopkeeper?" + params;
		parent.dvOpenDialog(url, "店长订单统计", 800, 430, null);
	}
			...
			<div class="padding_2_div">
				<table class="list_table">
					...
					<tr>
						...
						<td><input type="button" name="querySeller" value="店长订单统计" class="button" onclick="reportManagerSchool_onclick(<c:out value="${bean.school_id }"/>);"/></td>
					</tr>
					</c:forEach>
				</table>
			</div>
