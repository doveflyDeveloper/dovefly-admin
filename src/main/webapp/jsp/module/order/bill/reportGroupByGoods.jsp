...
<script type="text/javascript">
	...
	function query_onclick() {
		if (validateForm()){
			formHelper.jSubmit(formHelper.buildAction("orderBillReportController", "reportGroupByGoods"));
		}
	}
	...
	function export_onclick() {
		...
		formHelper.submit(formHelper.buildAction("orderBillReportController", "exportGroupByGoods", ids));
	}
...
<body>
	<form id="form" name="form" method="get">
		...
		<div class="border_div" >
			<div class="header_div">
				<div class="left_div">
					<div class="table_title">统计列表&nbsp;&nbsp;&nbsp;&nbsp;(未发货，已发货，已收货 三种状态下的订单)</div>
				</div>
				<div class="right_div">
					<div class="right_menu">
