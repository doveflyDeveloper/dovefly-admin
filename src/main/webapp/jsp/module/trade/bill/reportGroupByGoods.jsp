...
<script type="text/javascript">
	...
	function query_onclick() {
		if (validateForm()){
			formHelper.jSubmit(formHelper.buildAction("tradeBillReportController", "reportGroupByGoods"));
		}
	}
	...
	function export_onclick() {
		...
		formHelper.submit(formHelper.buildAction("tradeBillReportController", "exportGroupByGoods", ids));
	}
