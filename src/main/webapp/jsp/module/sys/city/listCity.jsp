...
<body>
	<form id="form" name="form" method="get">
			...
			<div class="padding_2_div">
				<table class="query_table">
					<tr>
						...
						<td class="field">
							<input type="text" name="name" class="input" maxlength="10" value="<c:out value="${param.name }"/>"/>
						</td>
						<td class="label"></td>
						<td class="field"></td>
					</tr>
		...
		<div class="border_div" >
			<div class="header_div">
				<div class="left_div">
					<div class="table_title">城市列表&nbsp;</div>
				</div>
				<div class="right_div">
					<div class="right_menu">
			...
			<div class="padding_2_div">
				<table class="list_table">
					...
					<tr>
						...
						<td><c:out value="${bean.df_supplier_name }"/></td>
