...
<script type="text/javascript">
	...
	/** 授权 */
	function findForAuthRes_onclick(id){
		var sels = findSelections("dv_checkbox");
		if(!sels || !sels.length) {
	  		dvAlert("请选择一条记录！");
	  		return false;
		...
		var id = $(sels[0]).val();
		formHelper.jSubmit(formHelper.buildAction("roleController", "findForAuthRes" , id));
	}
		...
		<div class="border_div" >
			<div class="header_div">
				<div class="left_div">
					...
					<div class="table_title_tip" title="不会操作？点我吧！" rel="<%=request.getContextPath()%>/helpController/getHelp/sys_role"></div>
				</div>
				<div class="right_div">
			...
			<div class="header_div">
				...
				<div class="right_div">
					<div class="right_menu">
						...
						<input type="button" name="authorize" value="授权资源" class="button" onclick="findForAuthRes_onclick();"/>
					</div>
				</div>
			</div>
			<div class="padding_2_div">
