	...
	<form id="form" name="form" method="post">
		...
		<div class="border_div" >
			<div class="header_div">
				<div class="left_div">
					<div class="table_title">角色<%= isModify ? "修改" : "新增"%>&nbsp;</div>
			...
			<div>
				<table class="insert_table">
					<tr>
						<td class="label"><span class="required_red">* </span>角色名称：</td>
						<td class="field">
							<input type="text" name="name" class="input" inputName="角色名称" value="<c:out value="${bean.name }"/>" maxlength="50" validate="notNull"/>
						</td>
