...
<body>
	<form id="form" name="form" method="get">
			...
			<div class="padding_2_div">
				<table class="query_table">
					<tr>
						...
						<td class="field">
							<dv:select name="module" dicKeyword="DIC_MODULE" hasEmpty="true" defaultValue="${param.module }"></dv:select>
						</td>
						<td class="label">功能：</td>
						<td class="field">
							<input type="text" name="operation" class="input" maxlength="50" value="<c:out value="${param.operation }"/>"/>
						</td>
					</tr>
				</table>
			</div>
		...
		<div class="border_div" >
			<div class="header_div">
				<div class="left_div">
					<div class="table_title">帮助指南列表&nbsp;</div>
				</div>
				<div class="right_div">
					<div class="right_menu">
			...
			<div class="padding_2_div">
				<table class="list_table">
					...
					<tr>
						...
						<td>${status.count }</td>
						<td><a href="javascript:detail_onclick('<c:out value="${bean.id }"/>')"><dv:display dicKeyword="DIC_MODULE" value="${bean.module }"/></a></td>
