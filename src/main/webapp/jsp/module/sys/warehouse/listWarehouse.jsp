...
<body>
	<form id="form" name="form" method="get">
			...
			<div class="padding_2_div">
				<table class="query_table">
					<tr>
						...
						<td class="field">
							<dv:select name="city_id" dicKeyword="DIC_SYS_CITY" defaultValue="${param.city_id }" hasEmpty="true"/>
						</td>
						<td class="label">货仓：</td>
						<td class="field">
							<input type="text" name="warehouse_name" class="input" maxlength="10" value="<c:out value="${param.warehouse_name }"/>"/>
						</td>
					</tr>
				</table>
			</div>
		...
		<div class="border_div" >
			<div class="header_div">
				<div class="left_div">
					<div class="table_title">货仓列表&nbsp;</div>
				</div>
				<div class="right_div">
					<div class="right_menu">
			...
			<div class="padding_2_div">
				<table class="list_table">
					...
					<tr>
						...
						<td><a href="javascript:detail_onclick('<c:out value="${bean.id }"/>')"><c:out value="${bean.warehouse_name }"/></a></td>
						<td><c:out value="${bean.warehouse_desc }"/></td>
						<td><c:out value="${bean.warehouse_area }"/></td>
