...
<script type="text/javascript">
	...
	function save_onclick() {
		...
		formHelper.jSubmit(formHelper.buildAction("resourceController", "sort", "<c:out value="${bean.id }"/>"));
	}
	...
	function down_onclick(downBtn) {
		var lineNum = $("#res_list_table tr").length;//总行数
	...
	$(document).ready(function() {
		$("#res_list_table").dragsort({ dragSelector: "tr", dragSelectorExclude: "tr:first", dragBetween: false, dragEnd: saveOrder, placeHolderTemplate: "<tr></tr>" });
...
<body>
	<form id="form" name="form" method="post">
		<div class="border_div" style="margin:1px;">
			...
			<div class="padding_2_div">
				<table id="res_list_table" class="list_table">
					<tr>
						<th width="5%">
					...
					<tr>
						...
						<td><dv:display dicKeyword="DIC_RESOURCE_TYPE" value="${bean.type }"/></td>
						<td><c:out value="${bean.permission }"/></td>
						<td>
