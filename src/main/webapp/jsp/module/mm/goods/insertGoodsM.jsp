		...
		<div class="border_div" >
			<div class="header_div">
				<div class="left_div">
					...
					<div class="table_title_tip" title="不会操作？点我吧！" rel="<%=request.getContextPath()%>/helpController/getHelp/mm_goods_m"></div>
				</div>
				<div class="right_div">
					...
					<DD>
						<div>
							<table class="insert_table">
								...
								<tr>
									<td class="label"><span class="required_red">* </span>采购成本价：</td>
									<td class="field">
										<input type="text" name="cost_price" class="input" inputName="采购成本价" value="<c:out value="${bean.cost_price }"/>" validate="notNull"/>
									</td>
