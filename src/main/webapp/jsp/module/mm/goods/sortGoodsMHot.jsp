...
<script type="text/javascript">
	...
	function ok_onclick() {
		...
		$.ajax({
			...
			async: true,
			dataType: "json",
			url: context_path + "/goodsMHotController/sort",
...
<body>
	<form id="form" name="form" method="post">
		<ul id="goods_list">
			...
			<li><div><img class="thumbnail" special_id="${bean.id }" src="<c:out value="${bean.goods_image }"/>?imageView2/0/w/50"/></div></li>
			</c:forEach>
		</ul>
	</form>
</body>
