					...
					<DD>
						<div>
							<table class="detail_table">
								...
								<tr>
									<td class="label">采购成本价：</td>
									<td class="field"><c:out value="${bean.cost_price }"/></td>
								...
								<tr>
									...
									<td class="field"><c:out value="${bean.max_limit }"/></td>
									<td class="label">店长进货限购规则：</td>
									<td class="field"><c:out value="${bean.buy_rule }"/></td>
								</tr>
								<tr>
