...
<body style="width:8cm;padding:2px;margin:2px;">
	...
	【订单编号】<c:out value="${bean.bill_code }"/><br>
	【订单日期】<c:out value="${bean.bill_date }"/><br>
	【订单金额】￥<c:out value="${bean.amount }"/><br>
	【入库状态】<dv:display dicKeyword="DIC_PURCHASE_BILL_STATUS" value="${bean.status }"/><br>
	</div>
	<br>
	<div>
