...
<script type="text/javascript">
	...
	function exportList_onclick() {
		...
		formHelper.submit(formHelper.buildAction("purchaseBillController", "exportList", ids));
	}
	...
	function exportListDetail_onclick() {
		var ids = findSelections("dv_checkbox", "value");
		if(!ids || ids.length == 0) ids = "all";
		formHelper.submit(formHelper.buildAction("purchaseBillController", "exportListDetail", ids));
	}
			...
			<div class="padding_2_div">
				<table class="list_table">
					...
					<tr>
						...
						<td><dv:display dicKeyword="DIC_PURCHASE_BILL_STATUS" value="${bean.status }"/></td>
					</tr>
					</c:forEach>
				</table>
			</div>
